...
class AddAddressDataSourceImpl implements AddAddressDataSourceContract {
  final AddAddressApiClient _addAddressApiClient;

  AddAddressDataSourceImpl(this._addAddressApiClient);
  ...
  Future<BaseResponse<List<AddAddressDto>>> addNewAddress({
    ...
    try {
      final response = await _addAddressApiClient.addNewAddress(
        request: request,
      );
