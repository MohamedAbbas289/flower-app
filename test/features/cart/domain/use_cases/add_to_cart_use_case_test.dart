...
void main() {
  ...
  setUp(() {
    ...
    useCase = AddToCartUseCase(mockCartRepoContract);
  ...
  test('returns SuccessBaseResponse with CartEntity on success', () async {
    when(
      mockCartRepoContract.addToCart(tProductId, tQuantity),
    ...
    verify(mockCartRepoContract.addToCart(tProductId, tQuantity)).called(1);
